...
const T = {
  fr: {
    ...
    s5: "4. Données personnelles et confidentialité",
    ...
    s7: "6. Responsabilité et limitation",
    ...
    s8: "7. Droit applicable et juridiction",
  ...
  ar: {
    ...
    s8: "7. القانون المعمول به والاختصاص القضائي",
